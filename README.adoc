...
In this example we show a closer to production implementation of a session-based authentication mechanism with Actix-Web using its built-in middlewares.
